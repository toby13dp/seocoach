...
import { cancelExperiment } from '@/lib/experiments';

// POST /api/projects/[id]/experiments/[experimentId]/cancel — Cancel experiment
export async function POST(
  ...
  try {
    ...
    const experiment = await cancelExperiment(experimentId, projectId);
